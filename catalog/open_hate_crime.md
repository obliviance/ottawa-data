...
`open_hate_crime` · shape **arcgis-hub** · source `open-ottawa`

- origin: <https://open.ottawa.ca/datasets/ottawa::hate-crime>
...
- Trend / seasonality of open_hate_crime over `Year`; structural breaks?

_profiled 2026-09-09 · `python3 tools/profile.py open_hate_crime`_
