...
`ops_theft_of_motor_vehicle_open_data` · shape **arcgis-hub** · source `ops-data-portal`

- origin: <https://data.ottawapolice.ca/datasets/e5453a203e2a4baeac32ac4e70ce852c_0>
...
- Trend / seasonality of ops_theft_of_motor_vehicle_open_data over `Vehicle Year`; structural breaks?

_profiled 2026-09-09 · `python3 tools/profile.py ops_theft_of_motor_vehicle_open_data`_
