...
`open_community_police_centres` · shape **arcgis-hub** · source `open-ottawa`

- origin: <https://open.ottawa.ca/datasets/ottawa::community-police-centres-1>
...
_profiled 2026-09-09 · `python3 tools/profile.py open_community_police_centres`_
