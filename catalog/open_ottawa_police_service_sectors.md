# Ottawa Police Service Sectors

`open_ottawa_police_service_sectors` · shape **arcgis-hub** · source `open-ottawa`

- origin: <https://open.ottawa.ca/datasets/ottawa::ottawa-police-service-sectors>
...
_profiled 2026-09-09 · `python3 tools/profile.py open_ottawa_police_service_sectors`_
