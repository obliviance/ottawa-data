...
`open_bike_theft` · shape **arcgis-hub** · source `open-ottawa`

- origin: <https://open.ottawa.ca/datasets/ottawa::bike-theft>
...
- Trend / seasonality of open_bike_theft over `Year`; structural breaks?

_profiled 2026-09-09 · `python3 tools/profile.py open_bike_theft`_
